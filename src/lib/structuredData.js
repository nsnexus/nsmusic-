...
export function serviceJsonLd() {
  return {
    ...
    areaServed: 'BR',
    description:
      'Música composta do zero a partir da história do cliente: letra exclusiva e duas versões completas em MP3 HD, prontas em cerca de 2 a 3 minutos.',
    offers: [
  ...
  return {
    ...
    step: [
      ...
      },
      {
        ...
        text: 'Em cerca de 2 a 3 minutos ficam prontas duas versões da música. Ouça a prévia e libere o download completo após o pagamento por Pix.',
        url: `${BASE}/criar`,
      },
    ],
  };
